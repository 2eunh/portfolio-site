export const portfolios = [
  {
    ...
    review:
      "성과: CSS와 Framer Motion을 활용하여 동적 애니메이션을 구현하며, 사용자 경험을 향상시키는 인터랙티브한 UI 요소를 개발했습니다. 이를 통해 CSS 애니메이션의 기초를 다시 다지는 동시에, 자연스럽고 부드러운 전환 효과를 적용하는 방법을 익혔습니다. 프로젝트 전반에 걸쳐 애니메이션을 최적화하여 성능 저하 없이 매끄러운 화면 전환을 구현하였습니다.",
    review2:
  ...
  },
  {
    ...
    review:
      "성과: 노마드코더의 넷플릭스 클론 코딩 강의를 수강하며, React와 Framer Motion을 활용한 동적 UI 구현 방법을 익혔습니다. 수업 내용을 넘어, 유튜브 API를 연동하여 실제 넷플릭스와 유사한 인터페이스를 구현했으며, 이를 통해 API 연동, 데이터 처리 및 동적 콘텐츠 로딩에 대한 실무 경험을 쌓았습니다. 이 과정에서 인터랙티브한 화면 전환과 효율적인 콘텐츠 관리 방안을 익혔습니다.",
  },
  {
    id: 4,
    title: "To do list",
